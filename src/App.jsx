      ...
      <div className="page-wrapper">
        ...
        <main className="main-content">
          <Routes>
            ...
            <Route path="/painel-monitor" element={<MonitorDashboard user={user} monitors={monitors} submissions={submissions} avaliadores={avaliadores} events={events} ingressos={ingressos} onUpdateIngresso={handleUpdateIngresso} />} />
